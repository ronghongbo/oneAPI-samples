...
/** Allocate/free/copy device/host memory to back a halide_buffer_t. */
...
extern void halide_sycl_device_malloc(struct halide_buffer_t *buf, const sycl::queue &q_device);
extern void halide_sycl_host_malloc(struct halide_buffer_t *buf);
extern void halide_sycl_device_and_host_malloc(struct halide_buffer_t *buf, const sycl::queue &q_device);
