...
#cd $PATH_TO_SCRIPT
cd $HOME/oneAPI-samples-ronghongbo/DirectProgramming/C++SYCL_FPGA/ReferenceDesigns/productive_libraries/blas/gemm/3x3/XYZInitHoisted-fpgaregReduced-ProductChannelNoFpgareg-VarScoped
